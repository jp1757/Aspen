...
def fx_adjust(
    *,
    ...
    # Re-index total return prices & fx to align with dates
    ...
    # Adjust the asset total return prices by fx values
    if base_denominated:
...
class Portfolio(object):
    ...
    def __init__(
        ...
        *,
        ...
        self.fx = fx
        self.fx_map = fx_map
        fx_params = [fx_base, base_denominated, fx, fx_map]
        ...
        if params_set == 4:
            ...
            raise ValueError(
                "Please set all fx related params to apply an fx adjustment to asset "
                "total returns"
            )
